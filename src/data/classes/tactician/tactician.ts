		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Might],
						tier1: '3 + С шкоди; С < [слабкий], приголомшений (рят. кидок закінчує)',
						tier2: '5 + С шкоди; С < [середній], приголомшений (рят. кидок закінчує)',
						tier3: '8 + С шкоди; С < [сильний], приголомшений (рят. кидок закінчує)'
					})
				)
			]
		}),
