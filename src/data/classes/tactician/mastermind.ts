	...
	featuresByLevel: [
		{
			...
			features: [
				...
				FactoryLogic.feature.create({
					...
					description: `
Ваші енциклопедичні знання з історії битв дозволяють застосовувати їх до поточних викликів. Поки ви присутні, кожний герой поряд із вами трактує проєкт «Дослідити знання», повʼязаний з війною або битвою, на одну категорію дешевше. Це робить проєкти пошуку загальних відомостей безкоштовними, але такі проєкти все одно вимагають дії перепочинку для завершення.
