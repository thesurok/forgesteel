	...
	abilities: [
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '5 + Л ушкодження',
						tier2: '7 + Л ушкодження',
						tier3: '10 + Л ушкодження'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
					characteristic: [Characteristic.Agility],
					tier1: '4 + Л ушкодження; Л < [слабкий], схоплений',
					tier2: '7 + Л ушкодження; Л < [середній], схоплений',
					tier3: '9 + Л ушкодження; Л < [сильний], схоплений'
				}))
			]
		}),
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
					characteristic: [Characteristic.Agility],
					tier1: '4 + Л ушкодження; провокований (до кінця ходу)',
					tier2: '5 + Л ушкодження; провокований (до кінця ходу); зсув 1',
					tier3: '6 + Л ушкодження; провокований (до кінця ходу); зсув 2'
				}))
			]
		}),
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
					characteristic: [Characteristic.Agility],
					tier1: '5 + Л психічне ушкодження; вертикальне притягнення 1',
					tier2: '8 + Л психічне ушкодження; вертикальне притягнення 2',
					tier3: '11 + Л психічне ушкодження; вертикальне притягнення 3'
				}))
			]
		}),
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '4 + Л ушкодження; штовх 2',
						tier2: '6 + Л ушкодження; штовх 4',
						tier3: '8 + Л ушкодження; штовх 6'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
					characteristic: [Characteristic.Agility],
					tier1: '4 + Л ушкодження; Л < [слабкий], ослаблений (рят. кидок)',
					tier2: '7 + Л ушкодження; Л < [середній], ослаблений (рят. кидок)',
					tier3: '9 + Л ушкодження; Л < [сильний], ослаблений (рят. кидок)'
				}))
			]
		}),
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '7 + Л ушкодження',
						tier2: '10 + Л ушкодження',
						tier3: '13 + Л ушкодження'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '6 + Л ушкодження',
						tier2: '8 + Л ушкодження',
						tier3: '12 + Л ушкодження'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
					characteristic: [Characteristic.Agility],
					tier1: '4 + Л ушкодження; І < [слабкий], оглушений і сповільнений (рят. кидок)',
					tier2: '5 + Л ушкодження; І < [середній], оглушений і сповільнений (рят. кидок)',
					tier3: '7 + Л ушкодження; І < [сильний], оглушений і сповільнений (рят. кидок)'
				}))
			]
		}),
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '8 + Л психічне ушкодження; С < [слабкий], ослаблений (рят. кидок)',
						tier2: '12 + Л психічне ушкодження; С < [середній], ослаблений (рят. кидок)',
						tier3: '16 + Л психічне ушкодження; С < [сильний], ослаблений (рят. кидок)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '3 + Л психічне ушкодження; І < [слабкий], ціль виходить з фази (рят. кидок)',
						tier2: '4 + Л психічне ушкодження; І < [середній], ціль виходить з фази (рят. кидок)',
						tier3: '6 + Л психічне ушкодження; І < [сильний], ціль виходить з фази (рят. кидок)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			cost: 7,
			sections: [
				FactoryLogic.createAbilitySectionText('До кінця сутички розмір вашої здібності «Нульове поле» збільшується на 1. Поки область так збільшена, кожен ворог з І < [середній], який вперше в раунді входить в область або починає свій хід там, отримує bleeding (save ends). Кожен союзник, який вперше в раунді входить в область або починає там свій хід, отримує тимчасову витривалість, рівну вашому показникові Інтуїції.')
			]
		}),
		FactoryLogic.createAbility({
			id: 'null-ability-19',
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '7 + Л ушкодження; І < [слабкий], звʼязаний (рят. кидок)',
						tier2: '10 + Л ушкодження; І < [середній], звʼязаний (рят. кидок)',
						tier3: '13 + Л ушкодження; І < [сильний], звʼязаний (рят. кидок)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '10 + Л ушкодження; Л < [слабкий], схоплений',
						tier2: '14 + Л ушкодження; Л < [середній], схоплений',
						tier3: '18 + Л ушкодження; Л < [сильний], схоплений'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '13 + Л ушкодження; С < [слабкий], ціль пригнічена (рят. кидок)',
						tier2: '19 + Л ушкодження; С < [середній], ціль пригнічена (рят. кидок)',
						tier3: '24 + Л ушкодження; С < [сильний], ціль пригнічена (рят. кидок)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Agility],
						tier1: '9 + Л ушкодження; штовх 5; І < [слабкий], оглушений (рят. кидок)',
						tier2: '13 + Л ушкодження; штовх 7; І < [середній], оглушений (рят. кидок)',
						tier3: '18 + Л ушкодження; штовх 10; І < [сильний], оглушений (рят. кидок)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			cost: 11,
			sections: [
				FactoryLogic.createAbilitySectionText('Ціль отримує половину ушкодження, і якщо істота, що спричинила тригер, має І < [середній], вона стає приголомшеною (рят. кидок). Поки істота, що спричинила тригер, є приголомшеною таким чином, вона отримує психічне ушкодження, рівне вашому показникові Інтуїції, щоразу, коли використовує основну дію.')
			]
		})
	],
	subclasses: [
