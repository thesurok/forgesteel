								...
								ability: FactoryLogic.createAbility({
									...
									sections: [
										FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
											...
											tier1: '8 + С священної шкоди; П < [weak], зляканий (рят. кидок)',
											tier2: '12 + С священної шкоди; П < [average], зляканий (рят. кидок)',
											tier3: '15 + С священної шкоди; П < [strong], зляканий (рят. кидок)'
										})),
							...
							feature: FactoryLogic.feature.createAbility({
								ability: FactoryLogic.createAbility({
									...
									sections: [
										FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
											characteristic: [Characteristic.Might],
											tier1: '5 + С шкоди; П < [weak], ціль вигнана (рят. кидок)',
											tier2: '8 + С шкоди; П < [average], ціль вигнана (рят. кидок)',
											tier3: '11 + С шкоди; П < [strong], ціль вигнана (рят. кидок)'
										})),
							...
							feature: FactoryLogic.feature.createAbility({
								ability: FactoryLogic.createAbility({
									...
									sections: [
										FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
											characteristic: [Characteristic.Presence],
											tier1: '7 + П психічної шкоди; П < [weak], зляканий (рят. кидок)',
											tier2: '10 + П психічної шкоди; П < [average], зляканий (рят. кидок)',
											tier3: '12 + П психічної шкоди; П < [strong], зляканий (рят. кидок)'
										})),
