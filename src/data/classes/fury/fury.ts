...
Коли будь-яка стихійна істота або інша істота, чії здібності завдають кислотного, холодного, корупційного, вогняного, блискавичного, отруйного або звукового ушкодження, вперше помічає вас у бою, якщо в неї П < [сильний], вона наляканa вами (рят. кидок закінчує).
...
Первісна сила зберігається, поки ви її не витратите.`
	...
	abilities: [
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						...
						tier1: '2 + С ушкоджень',
						tier2: '5 + С ушкоджень',
						tier3: '7 + С ушкоджень; Л < [сильний], сповільнений (рят. кидок закінчує)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			cost: 7,
			sections: [
				FactoryLogic.createAbilitySectionText('До кінця зустрічі або поки ви не станете вмираючим, кожен ворог, який починає свій хід поруч з вами і має П < [сильний], стає переляканим до кінця свого ходу.')
			]
		}),
		FactoryLogic.createAbility({
			id: 'fury-ability-14',
			...
			cost: 7,
			sections: [
				FactoryLogic.createAbilitySectionText('До кінця зустрічі або поки ви не станете вмираючим, кожна істота, якій ви завдаєте удару в ближньому бою і в якої П < [середній], стає спровокованою до кінця її наступного ходу. Додатково, коли ви використовуєте здібність з кидком пошкодження проти ворога, спровокованого вами, здібність завдає додаткову шкоду, рівну двом вашим показникам Сили, і збільшує свою потужність на 1.')
			]
		}),
		FactoryLogic.createAbility({
			id: 'fury-ability-15',
