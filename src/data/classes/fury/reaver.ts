							...
							feature: FactoryLogic.feature.createAbility({
								ability: FactoryLogic.createAbility({
									...
									sections: [
										...
										FactoryLogic.createAbilitySectionText('Якщо ціль, що не є лідером або одиночним створінням, захекана цим ударом, її Витривалість знижується до 0, і ви обираєте ворога в межах 5 клітинок від вас. Якщо той ворог має П < [середній], він наляканий вами (рят. кидок закінчує).')
									]
								})
							}),
							value: 1
