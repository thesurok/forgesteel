		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Presence],
						tier1: '2 + П психічної шкоди; П < [слабкий], кровотеча (рят. кидок закінчує)',
						tier2: '5 + П психічної шкоди; П < [середній], кровотеча (рят. кидок закінчує)',
						tier3: '7 + П психічної шкоди; П < [сильний], кровотеча (рят. кидок закінчує)'
					})
				)
			]
		}),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Presence],
						tier1: 'зсунути на 1; І < [слабкий], приголомшений (рят. кидок закінчує)',
						tier2: 'зсунути на 1; І < [середній], приголомшений (рят. кидок закінчує)',
						tier3: 'зсунути на 2; І < [сильний], приголомшений (рят. кидок закінчує)'
					})
				),
				FactoryLogic.createAbilitySectionSpend({
					value: 2,
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Presence],
						tier1: '4 шкоди; П < [слабкий], сповільнений (рят. кидок закінчує)',
						tier2: '5 шкоди; П < [середній], сповільнений (рят. кидок закінчує)',
						tier3: '6 шкоди; П < [сильний], скутий (рят. кидок закінчує)'
					})
				),
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						...
						tier2: '10 + Л шкоди; П < [середній], ослаблений (рят. кидок закінчує)',
						tier3: '14 + Л шкоди; П < [сильний], ослаблений (рят. кидок закінчує)'
					})
				),
		...
		FactoryLogic.createAbility({
			...
			sections: [
				FactoryLogic.createAbilitySectionRoll(
					FactoryLogic.createPowerRoll({
						characteristic: [Characteristic.Presence],
						tier1: '6 шкоди; П < [слабкий], ціль не може добровільно залишити зону (до кінця ходу)',
						tier2: '8 шкоди; П < [середній], ціль не може добровільно залишити зону (рят. кидок закінчує)',
						tier3: '12 шкоди; ціль не може добровільно залишити зону (до кінця ходу); якщо П < [сильний], вона не може добровільно залишити зону (рят. кидок закінчує)'
					})
				),
