							...
							feature: FactoryLogic.feature.createAbility({
								ability: FactoryLogic.createAbility({
									...
									sections: [
										FactoryLogic.createAbilitySectionRoll(FactoryLogic.createPowerRoll({
											characteristic: [Characteristic.Agility],
											tier1: '2 шкоди; якщо у цілі Р < [слабкий], перед вирішенням шкоди вона виконує безкоштовний удар.',
											tier2: '5 шкоди; якщо у цілі Р < [середній], перед вирішенням шкоди вона використовує основну здібність на ваш вибір.',
											tier3: '7 шкоди; якщо у цілі Р < [сильний], перед вирішенням шкоди вона може зміститись на відстань, що не перевищує її швидкість, і використати основну здібність на ваш вибір.'
										})),
