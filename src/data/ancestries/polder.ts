...
Якщо поверхня, до якої ви сплющені, знищується, ця здібність закінчується, і ви отримуєте 1d6 шкоди, яку неможливо зменшити жодним чином.`)
	...
	ancestryPoints: 4,
	culture: FactoryLogic.createCulture('Полдер', 'Міський, комунальний, творчий.', CultureType.Ancestral, EnvironmentData.urban, OrganizationData.communal, UpbringingData.creative, 'Кхурсіріан (Khoursirian)')
};
