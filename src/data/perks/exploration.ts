...
export class ExplorationPerkData {
	...
	static monsterWhisperer: Perk = {
		...
		description: 'Ви можете використовувати навичку Догляд за тваринами, щоб взаємодіяти з нерозумними істотами, які не є тваринами.',
		type: FeatureType.Text,
		data: null,
		list: PerkList.Exploration
	};
