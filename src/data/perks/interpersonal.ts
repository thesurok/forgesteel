...
export class InterpersonalPerkData {
	static charmingLiar: Perk = {
		...
		description: 'Якщо ви провалюєте тест із навичкою Брехня, то не зазнаєте жодних наслідків, повʼязаних із провалом. Додатково, під час переговорів вас можуть спіймати на одній брехні без негативних наслідків. Після використання будь-якої з переваг цієї особливості ви не можете використати її знову, доки не здобудете 1 або більше перемог.',
	...
	static harmonizer: Perk = {
		id: 'perk-harmonizer',
		name: 'Гармонізатор',
		description: 'Ви можете робити тест Присутності з навичкою Музика, щоб впливати на істот, які не мають емоцій або не можуть вас зрозуміти. Додатково, один раз під час переговорів, коли союзник висуває аргумент, ви можете заграти музику, щоб дати цьому союзникові перевагу на його тест.',
		type: FeatureType.Text,
		data: null,
		list: PerkList.Interpersonal
	};
	...
	static powerPlayer: Perk = {
		...
		name: 'Гра мʼязами',
		description: 'Кожного разу, коли ви робите тест із навичками Вихваляння, Флірт або Залякування, ви можете використовувати Силу замість будь-якої іншої характеристики, яку вимагає цей тест.',
		type: FeatureType.Text,
		data: null,
		list: PerkList.Interpersonal
	};
