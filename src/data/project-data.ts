...
When the project is completed, you have an airship. You and any creatures you designate can operate the ship by touching the ship's wheel. During combat, a creature touching the wheel can use a маневр to make the ship move up to 10 squares. The ship can be moved only once per round. Out of combat, the ship has a speed of 130 miles per day.
...
| 2    | While fishing, the hero reels in a note in a bottle. The note is written in Анжалі (Anjali) and binds the reader into a deal with a powerful devil if read out loud. This gives the devil ownership of the reader’s soul in exchange for rolling an additional d10 on all future Fishing project rolls.                                                                                                                                                                                                                                                                                                                                                                                                                        |
