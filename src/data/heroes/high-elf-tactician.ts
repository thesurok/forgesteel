				...
				featuresByLevel: [
					{
						...
						features: [
							...
							},
							{
								...
								description: '\nПоки союзники перебувають поруч із вами або діють за вашими планами, кожен із них отримує перевагу на випробування з будь-якою навичкою з групи інтриг. Крім того, ви можете використовувати навичку Лідерство, щоб допомагати іншій істоті з будь-яким випробуванням, у якому використовується навичка з групи інтриг.\n\nНа розсуд Director ви та ваші союзники можете використовувати навички з групи інтриг, щоб проводити дослідження або розвідку під час переговорів, а не поза ними.',
								type: 'Текст',
								data: null
							},
							{
				...
				featuresByLevel: [
					{
						...
						features: [
							...
							},
							{
								...
								description: '\nВаші енциклопедичні знання історії битв дозволяють вам застосовувати їх до сучасних викликів. Поки ви присутні, кожен герой поруч із вами вважає проєкт «Дослідити знання», повʼязаний із війною або битвою, на одну категорію дешевшим. Це робить безплатними проєкти з пошуку загальновідомих знань, але такі проєкти все одно потребують дії перепочинку для завершення.\n\nКрім того, якщо у вас є 24 години або більше до бойової сутички чи переговорів і ви маєте одну чи більше підказок або чуток щодо цієї сутички чи переговорів, ви можете зробити випробування Розуму як дію перепочинку.\n\nНаведені нижче результати випробування застосовуються до бойової сутички:\n\n| Кидок   | Ефект                                                                                                          |\n|:--------|:---------------------------------------------------------------------------------------------------------------|\n| ≤ 11    | Director повідомляє вам кількість істот у сутичці.                                                             |\n| 12 - 16 | Director повідомляє вам кількість і рівень істот у сутичці.                                                    |\n| ≥ 17    | Director повідомляє вам інформацію результату 2 рівня, і коли сутичка починається, усі вороги заскочені зненацька. |\n\nНаведені нижче результати випробування застосовуються до переговорів:\n\n| Кидок   | Ефект                                                                                                                                                    |\n|:--------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|\n| ≤ 11    | Director називає вам три мотиви, один із яких належить NPC у цих переговорах.                                                                          |\n| 12 - 16 | Director називає вам один мотив NPC у цих переговорах.                                                                                                  |\n| ≥ 17    | Director повідомляє вам інформацію результату 2 рівня, а ви та кожен ваш союзник отримуєте перевагу на випробування впливу на NPC під час переговорів. |\n\nВи можете зробити це випробування лише один раз для будь-якої сутички або переговорів.',
								type: 'Текст',
								data: null
							},
							{
