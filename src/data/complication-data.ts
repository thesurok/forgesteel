	...
	static exile: Complication = {
		...
		features: [
			FactoryLogic.feature.create({
				...
				description: 'Ви маєте бан на взаємодію з тими, хто бачить у вас представника країни, що вигнала вас. Також ви ризикуєте зустріти агентів, що прагнуть покарати вас.'
			})
		]
	};
	...
	static guiltyConscience: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				name: 'Недолік вини',
				description: 'Багато людей звинувачують вас у завданих злях. Вони можуть бути недружні або ворожі до вас — і ви розумієте їхню точку зору. Ви отримуєте бан на будь-яку перевірку взаємодії з тими, хто знає про ваші вчинки, а також на удари проти таких істот.'
			})
		]
	};
	...
	static hawkRider: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Люди, що знають походження вашого сідла, бояться з вами спілкуватися, бо переймаються, що Господарі Яструбів прийдуть за ними через асоціацію. Ви отримуєте бан на перевірки впливу на тих, хто знає про Господарів Яструбів і бачив вас з гігантським яструбом. Такі люди можуть повідомити Господарям Яструбів, які можуть прийти шукати вас на розсуд Режисера.'
			})
		]
	};
	...
	static hostBody: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Ви отримуєте бан на перевірки читання емоцій або мови тіла гуманоїдних істот.'
			}),
			FactoryLogic.feature.createDamageModifier({
	...
	static hunter: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Ви настільки одержимі полюванням, що маєте бан на перевірки відстеження інших істот.'
			})
		]
	};
	...
	static infernalContractButLikeBad: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Ваше тіло має пекельний знак. Ті, хто знається на релігії, бачать у ньому ознаку приналежності вашої душі до Пекла і отримують бан на перевірки взаємодії з вами (якщо тільки це не їхня уподобання). Крім того, коли ви помираєте, ваша душа йде до Пекла і не може бути відновлена.'
			})
		]
	};
	...
	static ivoryTower: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Режисер обирає одну зі здобутих навичок. Ви втрачаєте цю навичку і ніколи не зможете її знову опанувати. Крім того, ви отримуєте бан на будь-яку перевірку, де ця навичка застосовується.'
			})
		]
	};
	...
	static lucky: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Коли ви отримуєте результат рівня 1 на тесті й не витрачаєте геройський жетон на перезкидання, ви отримуєте бан на наступний тест.'
			})
		]
	};
	...
	static misunderstood: Complication = {
		...
		features: [
			FactoryLogic.feature.create({
				...
				description: 'Коли ви відкриваєте свою зовнішність істотам, які не знають вас особисто, ви отримуєте перевагу на тестах, де можна застосувати Brag або Intimidate, але отримуєте бан на тестах, де застосовні Flirt, Lead або Persuade.'
			})
		]
	};
	...
	static rival: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'У вашого суперника схожі характеристики, але є одне вміння, в якому він завжди був кращим, за рішенням Директора. Через це ви отримуєте бан на тести з використання цього вміння.'
			})
		]
	};
	...
	static vampireSire: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Поки ви маєте тимчасову Витривалість від цього ускладнення, у вас з’являються видимі ікла, ви отримуєте бан (bane) на тести Presence при взаємодії з гуманоїдами, і ваш вампірний пращур може відчувати ваше місцезнаходження.'
			})
		]
	};
	...
	static vowOfHonesty: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Коли ви брешете, ваша честь забруднюється, і ви втрачаєте перевагу цього ускладнення. Додатково, ви отримуєте бан (bane) на тести, що використовують навички міжособистісної групи. Ви можете позбутися бану і повернути перевагу лише через спокутивні дії, наприклад здобувши вибачення від тієї істоти, якій ви збрехали.'
			})
		]
	};
