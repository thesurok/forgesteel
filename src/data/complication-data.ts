	...
	static misunderstood: Complication = {
		...
		features: [
			FactoryLogic.feature.create({
				...
				description: 'Коли ви відкриваєте свою зовнішність істотам, які не знають вас особисто, ви отримуєте перевагу на тестах, де можна застосувати Вихваляння або Залякування, але отримуєте шкоду на тестах, де застосовні Флірт, Лідерство або Переконання.'
			})
		]
	};
	...
	static raisedByBeasts: Complication = {
		...
		features: [
			...
			FactoryLogic.feature.create({
				...
				description: 'Оберіть тип тварини, повʼязаний з тими, хто вам допоміг (наприклад, вовк). Ви отримуєте перевагу на перевірки Догляду за тваринами під час взаємодії з тваринами цього типу. Ви також можете спілкуватися з тваринами цього типу, ніби ділите спільну мову, і ці тварини зазвичай не ворожі до вас, якщо їх не примушують надприродні сили.'
			}),
			FactoryLogic.feature.create({
	...
	static shadowBorn: Complication = {
		...
		features: [
			FactoryLogic.feature.create({
				...
				description: 'Кожного разу, коли ви починаєте свій хід у стані прихованості, ви отримуєте 1 сплеск.'
			}),
			FactoryLogic.feature.createDamageModifier({
					...
					sections: [
						FactoryLogic.createAbilitySectionRoll(
							FactoryLogic.createPowerRoll({
								...
								tier1: 'Ви отримуєте болісне видіння, фрагментарне і незбагненне. Після завершення відпочинку ви втрачаєте 1 відновлення (Відновлення).',
